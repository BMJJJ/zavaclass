...
insert into board values (default, 'admin', '관리맨', '게시판 서비스를 시작합니다.','즐거운 게시판생활이 되세요.',default, '192.168.50.69',default,default,default);
...
insert into boardReply values (default, 24, 'hkd1234', '홍톰맨', default, '192.168.50.69','글을 참조 했습니다.')
insert into boardReply values (default, 13, 'hkd1234', '홍톰맨', default, '192.168.50.69','조아용')
insert into boardReply values (default, 15, 'hkd1234', '홍톰맨', default, '192.168.50.69','굿')
...
-- 부모글(15)의 댓글만 출력
select * from boardReply where boardIdx = 15;
select boardIdx,count(*) as replyCnt from boardReply where boardIdx = 15;

select * from board where idx = 15;
select *,(select count(*) from boardReply where boardIdx = 15) as replyCnt from board where idx = 15;
